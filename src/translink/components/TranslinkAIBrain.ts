...
export class TranslinkAIBrain {
    ...
    private onDecisionCallback: ((promptText: string, emotion: 'neutral' | 'confirming' | 'empathetic' | 'thinking' | 'error', event: string) => void) | null = null;
    ...
    setDecisionCallback(cb: (promptText: string, emotion: 'neutral' | 'confirming' | 'empathetic' | 'thinking' | 'error', event: string) => void): void {
        ...
        switch (event) {
            case 'fast_scroll':
                ...
                if (this.onDecisionCallback) {
                    ...
                    this.onDecisionCallback(prompt, 'thinking', 'fast_scroll');
                }
                break;
                ...
                if (newSection !== this.shortTermMemory.currentSection) {
                    ...
                    this.sectionChangeDebounceTimer = setTimeout(() => {
                        if (this.onDecisionCallback) {
                            ...
                            this.onDecisionCallback(prompt, 'confirming', 'section_change');
                        }
                    }, 1500);
                }
                break;
            ...
            case 'element_clicked':
                ...
                if (elemId.includes('telemetry-btn')) {
                    if (this.onDecisionCallback) {
                        ...
                        this.onDecisionCallback(prompt, 'confirming', 'element_clicked');
                    }
                }
                break;
            ...
            case 'assistant_click':
                ...
                if (this.onDecisionCallback) {
                    ...
                    this.onDecisionCallback(prompt, 'confirming', 'assistant_click');
                }
                break;
